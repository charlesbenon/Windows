...
BypassRAMCheck
```
<kbd><img width="625" height="369" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Regedit.png" /></kbd>
...
<kbd><img width="466" height="296" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Update.png" /></kbd>

For the drivers, you check if all the devices are recognized by the operating system by going to the Device Manager:

<kbd><img width="305" height="596" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Device-Manager.png" /></kbd>
...
<kbd><img width="409" height="551" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Performances.png" /></kbd>
...
<kbd><img width="877" height="430" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Disable-Apps.png" /></kbd>

* Disable Visual Effects:  Search Visual Effects and disable "Transparency effects" and "Animations effects"
<kbd><img width="463" height="290" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Visual-Effects.png" /></kbd>
...
<kbd><img width="1014" height="137" alt="powershell-delete" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Winget-uninstall.png" /></kbd>

When it is done, check the task manager (**Ctrl + Shift + Esc**) for CPU, Memory and disk usage:
<kbd><img width="916" height="535" alt="image" src="https://github.com/charlesbenon/Windows/blob/main/Windows11_Old_PC/Pictures/Resource-Usage.png" /></kbd>
